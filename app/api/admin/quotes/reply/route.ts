...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await recordAdminAudit({
      ...
      action: "quote.reply_sent",
      entityType: "studio_request",
      entityId: requestId,
      summary: `Replied to a quote question for ${studioRequest.project_name || studioRequest.service || "project"}`,
      metadata: { question_id: questionId, reply_id: reply.id },
    });
