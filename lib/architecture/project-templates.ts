...
const templates: Record<string, ArchitectureProjectTemplate> = {
  ...
  Healthcare: {
    label: "Healthcare",
    category: "healthcare",
    spaces: ["Arrival", "Reception", "Waiting", "Consult Rooms", "Treatment Rooms", "Procedure Rooms", "Patient Rooms", "Diagnostics", "Pharmacy", "Staff Areas", "Administration", "Clean Utility", "Dirty Utility", "Storage", "Bathrooms", "Service Access"],
    defaultSpaces: ["Arrival", "Reception", "Waiting", "Consult Rooms", "Treatment Rooms", "Staff Areas", "Administration", "Storage", "Bathrooms"],
    directionFocus: ["patient dignity", "clear wayfinding", "clinical workflow", "privacy", "daylight", "staff efficiency", "infection-control awareness", "calm atmosphere"],
    visualViews: ["Building Exterior", "Arrival", "Reception and Waiting", "Consult Room", "Treatment Room", "Patient Room", "Staff Area", "Healing Garden", "Aerial View"],
    simpleCapacityLabel: "Patients and staff",
    simpleCapacityPlaceholder: "Example: 120 patients per day and 35 staff",
  },
  Community: {
    label: "Community",
    category: "community",
