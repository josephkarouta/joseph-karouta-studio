export const CREDIT_COSTS = {
  ...
  imageToVideoFast720: 100,
  imageToVideoFast1080: 130,
  imageToVideoQuality720: 320,
  imageToVideoQuality1080: 320,
  aiUpscale2x: 30,
  aiUpscale4x: 60,
  powerpointDraft: 30,
  powerpointFull: 30,
  ...
  powerpoint16To20: 50,
  interiorConcept: 10,
  interiorProfessionalConcept: 10,
  interiorTechnicalPlan: 40,
  interiorPreview: 20,
  interiorProfessionalFinal: 20,
  interiorPlan: 20,
  interiorVisual: 20,
