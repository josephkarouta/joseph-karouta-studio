...
export async function generateArchitecturePlanSet(args: {
  ...
  return structuredCompletion<LivePlanSet>({
    ...
    system: [
      ...
      "Align stairs, wet areas, primary structural zones and major facade openings between levels. Upper floors must respond to the ground-floor geometry rather than becoming unrelated layouts.",
    ...
    payload: {
      ...
      canonical_plan_rules: {
        ...
        vertical_rules: "Stairs, wet cores, structural zones and major openings align between levels.",
