...
export const legalPages: Record<string, { eyebrow: string; title: string; summary: string; updated: string; sections: PublicSection[] }> = {
  terms: {
    ...
    sections: [
      ...
      { title: "Subscriptions and credits", paragraphs: ["Subscription plans provide access and recurring credit allowances according to the plan shown at checkout. Credits are a platform usage unit, not cash, and are consumed by eligible generation actions. Failed generation attempts should automatically release reserved credits."], bullets: ["Unused subscription credits expire at the end of each monthly credit period and are replaced by the next monthly plan allowance, including when a subscription is billed yearly.", "Purchased credit-pack credits do not expire and remain separate from subscription credits.", "Starter and Pro include cloud project, asset and version storage subject to reasonable fair-use limits.", "After a paid subscription ends, saved workspace files are normally available for a 30-day read-only download grace period before ordinary project/media files become eligible for removal.", "Custom expert production is not included unless explicitly stated in a quote."] },
      { title: "Expert Network applications", paragraphs: ["Applying to the Expert Network does not create employment, an Expert Portal account, a contractor engagement or a guarantee of project work. Heyy Studio may review the information you provide, contact shortlisted applicants and consider suitable applicants for future project opportunities."], bullets: ["You may decline any project opportunity before accepting it.", "You should keep your experience, availability and contact details accurate.", "Heyy Studio may close, pause or change Expert Network opportunities at any time."] },
      { title: "Expert project terms and payment", paragraphs: ["If Heyy Studio offers you a project, the scope, fee, currency, timeline, revisions, deliverables, payment schedule and any project-specific intellectual-property or confidentiality requirements will be confirmed before work begins. No project is accepted until the relevant terms are agreed."], bullets: ["Unless separately agreed in writing, Expert Network participation is project-based rather than employment.", "Experts remain responsible for their own tax, insurance, registration and legal eligibility requirements that apply to their work.", "Payment timing and method may vary by project and will be stated in the accepted project terms."] },
  ...
  privacy: {
    ...
    updated: "September 18, 2026",
    sections: [
      { title: "Information we collect", bullets: ["Account information such as name, email and authentication identifiers.", "Project briefs, prompts, uploads, generated outputs, assets and workspace activity.", "Subscription, quote and payment metadata provided by payment processors.", "Support, contact, career and production communications.", "Expert Network application information such as your CV or resume, portfolio or LinkedIn profile, location, time zone, experience, specialties, tools, languages, availability and application responses.", "Technical information needed for security, diagnostics and service operation."] },
      { title: "Expert Network applications", paragraphs: ["Expert Network application information is used to assess suitability, contact shortlisted applicants, match experts to relevant project opportunities and administer the network. Applications may be retained for future opportunities unless you ask Heyy Studio to delete them, subject to legal, security or record-keeping requirements."], bullets: ["Submitting an application does not create an Expert Portal account or guarantee project work.", "You can contact Heyy Studio to request access, correction or deletion of your application information."] },
      ...
      { title: "Cookies and analytics", paragraphs: ["Heyy Studio uses essential cookies or similar browser storage where needed for sign-in, security, preferences and core service operation. Optional analytics should remain off unless you choose to allow it through the Cookie Notice."], bullets: ["Rejecting optional analytics does not prevent access to core Heyy Studio features.", "Consent choices are stored so the site can remember the preference.", "Heyy Studio does not sell personal data to advertisers."] },
      { title: "Project privacy and retention", paragraphs: ["Project data is associated with the signed-in account and relevant workspace. Free accounts do not include the paid cloud Assets and Versions workspace. Starter and Pro include cloud project/media storage subject to fair use. When a paid subscription ends, saved workspace files are normally kept available in read-only form for a 30-day download grace period, after which ordinary project/media files may be removed. Financial, production, security or legally required records may be retained separately where necessary."] },
