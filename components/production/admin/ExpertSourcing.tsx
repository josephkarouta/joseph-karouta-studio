    ...
    <div className="heyy-source-root">
      ...
      <section className="heyy-source-card">
        <header className="heyy-source-head">
          ...
          <ShieldCheck size={22} color="#6c00ff" />
        </header>
