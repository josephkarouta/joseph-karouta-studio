        ...
        <>
          <section className="heyy-expertops-card">
            <div className="heyy-expertops-head">
              ...
              <UsersRound size={22} color="#6c00ff" />
            </div>
          ...
          <section className="heyy-expertops-card">
            <div className="heyy-expertops-head">
              ...
              <BadgeDollarSign size={22} color="#6c00ff" />
            </div>
            <div className="heyy-expertops-body">
...
<section className="heyy-expertops-card">
              <div className="heyy-expertops-head"><div><p className="heyy-expertops-kicker">Private communication</p><h2 className="heyy-expertops-title">Expert ↔ Heyy Admin</h2></div><MessageSquareText size={20} color="#6c00ff" /></div>
              <div className="heyy-expertops-body">
          ...
          {expertWorkspaceView === "payout" && (
            <section className="heyy-expertops-card">
              <div className="heyy-expertops-head">
                ...
                <CircleDollarSign size={22} color="#6c00ff" />
              </div>
              <div className="heyy-expertops-body">
