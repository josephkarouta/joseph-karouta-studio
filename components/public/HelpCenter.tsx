...
const defaults: Article[] = [
  { id: "1", slug: "getting-started", title: "Getting started with Heyy Studio", category: "Getting started", summary: "Choose a Studio, create a project and understand the connected workspace.", content: { sections: [{ title: "Choose the clearest starting point", paragraphs: ["Start in a specialist Studio when you already know the kind of project you need. Use Heyy when you need help choosing between a Studio, a focused Tool or expert support."], bullets: ["Save useful outputs to the workspace.", "Review credit cost before generation.", "Request expert production only when the concept and scope are clear."] }] } },
