  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="relative">
        ...
        <input value={query} onChange={(event) => setQuery(event.target.value)} className="heyy-form-field min-h-14 pl-12" placeholder="Search Studios, Tools, credits, billing, files or account help..."/>
      </div>
