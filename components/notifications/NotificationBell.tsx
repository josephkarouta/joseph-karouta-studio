  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="fixed left-3 right-3 top-[calc(var(--header-height)+8px)] z-[70] overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--surface-strong)] shadow-[var(--shadow-card-hover)] backdrop-blur-2xl sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-3 sm:w-[min(380px,calc(100vw-24px))]"
        >
