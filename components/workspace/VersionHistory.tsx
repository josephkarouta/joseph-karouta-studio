...
export default function VersionHistory(){
  ...
  useEffect(()=>{setVisibleCount(30);},[search,studio,project]);
  ...
  return <main className="min-h-screen bg-[var(--background)] px-4 py-6 text-[var(--text-primary)] sm:px-7 lg:px-10">
    <div className="mx-auto max-w-[1500px]">
      ...
      <section className="mt-5 rounded-[1.6rem] border border-[var(--border)] bg-[var(--surface)] p-4 shadow-sm"><div className="grid gap-3 lg:grid-cols-[1fr_190px_230px]">
